...
//     if (!textResponse) {
//       console.warn("⚠️ Gemini response missing expected text part.", response.data);
//       return res.json({
//         success: true,
...
//     console.error("❌ Gemini Error (/ask-question):", error.message);
//     if (error.response) {
//       console.error("Data:", error.response.data);
//       console.error("Status:", error.response.status);
//     } else if (error.request) {
...
app.listen(MOCK_PORT, () => {
  console.log(`----------------------------------------------------`);
  console.log(`🚀 Mock ESP32-CAM server running!`);
